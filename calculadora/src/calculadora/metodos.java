...
public class metodos {
    ...
    public double absolutoDoubleEntero ( double op1){ return Math.abs(op1); }  // Valor absoluto de un double
    public int absolutoIntEntero ( int op1){ return Math.abs(op1); }  // Valor absoluto de un entero
    ...
    // Raices --
    public double genericaR (double op1, double index)
    { // Raiz generica para cualesquiera dos números enteros
        return Math.pow(Math.E, Math.log(op1)/index);
        //return  Math.pow(op1, 1/index);
    } 
    public double cuadradoR (double op1){ return Math.sqrt(op1);} // Raiz cuadrada
    public double cubicoR (double op1){ return Math.cbrt(op1);} // Raiz cubica
}
